    ...
    return (
        <div className="w-11/12 mx-auto py-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {books.map(book => (
                    <div key={book.bookId} className="w-full bg-white border border-gray-200 rounded-xl overflow-hidden p-4">
                        ...
                        <div className="p-4">
                            <div className="flex gap-2 mb-3">
                                {book.tags.map(tag => (
                                    <span key={tag} className="text-xs px-3 py-1 rounded-full bg-green-100 text-green-700 font-medium">{tag}</span>
                                ))}
                            </div>
